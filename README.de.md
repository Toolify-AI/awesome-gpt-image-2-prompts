...
- Top-Tags: `Concept Art` (22), `Portrait` (17), `Photography` (14), `Social Media Post` (14), `Typography` (12), `Anime` (9), `Influencer` (9), `App UI` (9), `Minimalism` (9), `Manga` (7), `Web Design` (6), `Cinematic Lighting` (6)
...
| --- | --- |
| Prompts gesamt | **62** |
| Eindeutige Autoren | **41** |
| Eindeutige Tags | **78** |
| Letzte Aktualisierung im Datensatz | **2026-04-17 17:03:57** |
...
**Autor:** BubbleBrain
**Quelle:** [Originalbeitrag öffnen](https://x.com/BubbleBrain/status/2045052982728016131)
...
Führe den Generator nach einem Update von `toolify.json` aus:
