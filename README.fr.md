...
- [Comment régénérer](#how-to-refresh)
...
- Tags principaux: `Concept Art` (22), `Portrait` (17), `Photography` (14), `Social Media Post` (14), `Typography` (12), `Anime` (9), `Influencer` (9), `App UI` (9), `Minimalism` (9), `Manga` (7), `Web Design` (6), `Cinematic Lighting` (6)
...
| Indicateur | Valeur |
| --- | --- |
| Nombre de prompts | **62** |
| Auteurs uniques | **41** |
| Tags uniques | **78** |
| Dernière mise à jour du dataset | **2026-04-17 17:03:57** |
...
**Auteur :** BubbleBrain
**Source :** [Ouvrir le post d'origine](https://x.com/BubbleBrain/status/2045052982728016131)
**Tags :** Fashion Photography, Portrait, Fashion Model, Photography, Film Still
**Mis à jour :** 2026-04-17
...
Exécutez le générateur après avoir mis à jour `toolify.json` :
