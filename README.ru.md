...
- [Как пересобрать](#how-to-refresh)
...
- Основные теги: `Concept Art` (22), `Portrait` (17), `Photography` (14), `Social Media Post` (14), `Typography` (12), `Anime` (9), `Influencer` (9), `App UI` (9), `Minimalism` (9), `Manga` (7), `Web Design` (6), `Cinematic Lighting` (6)
...
| --- | --- |
| Всего промптов | **62** |
| Уникальных авторов | **41** |
| Уникальных тегов | **78** |
| Последнее обновление датасета | **2026-04-17 17:03:57** |
...
**Автор:** BubbleBrain
**Источник:** [Открыть оригинальный пост](https://x.com/BubbleBrain/status/2045052982728016131)
**Теги:** Fashion Photography, Portrait, Fashion Model, Photography, Film Still
**Обновлено:** 2026-04-17
...
После обновления `toolify.json` запустите генератор:
