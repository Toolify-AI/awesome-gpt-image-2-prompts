...
- Основные теги: `Concept Art` (32), `Portrait` (27), `Social Media Post` (24), `Typography` (20), `App UI` (19), `Photography` (19), `Minimalism` (16), `Poster` (15), `Web Design` (15), `Cinematic` (14), `Anime` (13), `Influencer` (12)
...
| --- | --- |
| Всего промптов | **107** |
| Уникальных авторов | **68** |
| Уникальных тегов | **97** |
| Последнее обновление датасета | **2026-04-18 23:10:46** |
...
- **Автор:** MapleShaw
- **Источник:** [Открыть оригинальный пост](https://x.com/msjiaozhu/status/2045470160576999812)
- **Теги:** App UI, Influencer, Social Media Post, Portrait
- **Обновлено:** 2026-04-18
...
- **Автор:** BubbleBrain
- **Источник:** [Открыть оригинальный пост](https://x.com/BubbleBrain/status/2045092449803284923)
- **Теги:** Portrait, Photography, Vintage, Medium Shot, Natural Light
- **Обновлено:** 2026-04-18
